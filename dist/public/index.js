...
class PublicClient {
  ...
  connect() {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this.pingInterval = PublicClient.startPings(_this.socket, _this.options.msBetweenPings);
    })();
  }
  ...
  reconnect() {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this2.pingInterval = PublicClient.startPings(_this2.socket, _this2.options.msBetweenPings);
    })();
  }
