...
export namespace ProtobufMarkets {
    ...
    interface IMarketUpdateMessage {
        ...
        spreadHistoryUpdate?: (ProtobufMarkets.ISpreadHistoryUpdate|null);
    }
    ...
    class MarketUpdateMessage implements IMarketUpdateMessage {
        ...
        /** MarketUpdateMessage spreadHistoryUpdate. */
        public spreadHistoryUpdate?: (ProtobufMarkets.ISpreadHistoryUpdate|null);

        /** MarketUpdateMessage Update. */
        public Update?: ("orderBookUpdate"|"orderBookDeltaUpdate"|"tradesUpdate"|"intervalsUpdate"|"summaryUpdate"|"sparklineUpdate"|"spreadHistoryUpdate");
    ...
    interface ISpreadHistoryUpdate {
        ...
        asks?: (ProtobufMarkets.SpreadHistoryUpdate.ISpreadHistoryPoint[]|null);

        /** SpreadHistoryUpdate bids */
        bids?: (ProtobufMarkets.SpreadHistoryUpdate.ISpreadHistoryPoint[]|null);
    ...
    /** Represents a SpreadHistoryUpdate. */
    class SpreadHistoryUpdate implements ISpreadHistoryUpdate {

        /**
         * Constructs a new SpreadHistoryUpdate.
         * @param [properties] Properties to set
         */
        constructor(properties?: ProtobufMarkets.ISpreadHistoryUpdate);

        /** SpreadHistoryUpdate asks. */
        public asks: ProtobufMarkets.SpreadHistoryUpdate.ISpreadHistoryPoint[];

        /** SpreadHistoryUpdate bids. */
        public bids: ProtobufMarkets.SpreadHistoryUpdate.ISpreadHistoryPoint[];
         ...
         * @param [properties] Properties to set
         * @returns SpreadHistoryUpdate instance
         */
        public static create(properties?: ProtobufMarkets.ISpreadHistoryUpdate): ProtobufMarkets.SpreadHistoryUpdate;
         ...
         * @param message SpreadHistoryUpdate message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: ProtobufMarkets.ISpreadHistoryUpdate, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: ProtobufMarkets.ISpreadHistoryUpdate, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a SpreadHistoryUpdate message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns SpreadHistoryUpdate
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): ProtobufMarkets.SpreadHistoryUpdate;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): ProtobufMarkets.SpreadHistoryUpdate;
         ...
         * @returns SpreadHistoryUpdate
         */
        public static fromObject(object: { [k: string]: any }): ProtobufMarkets.SpreadHistoryUpdate;

        /**
         * Creates a plain object from a SpreadHistoryUpdate message. Also converts values to other types if specified.
         * @param message SpreadHistoryUpdate
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: ProtobufMarkets.SpreadHistoryUpdate, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    namespace SpreadHistoryUpdate {
        ...
        /** Represents a SpreadHistoryPoint. */
        class SpreadHistoryPoint implements ISpreadHistoryPoint {

            /**
             * Constructs a new SpreadHistoryPoint.
             * @param [properties] Properties to set
             */
            constructor(properties?: ProtobufMarkets.SpreadHistoryUpdate.ISpreadHistoryPoint);
             ...
             * @param [properties] Properties to set
             * @returns SpreadHistoryPoint instance
             */
            public static create(properties?: ProtobufMarkets.SpreadHistoryUpdate.ISpreadHistoryPoint): ProtobufMarkets.SpreadHistoryUpdate.SpreadHistoryPoint;
             ...
             * @param message SpreadHistoryPoint message or plain object to encode
             * @param [writer] Writer to encode to
             * @returns Writer
             */
            public static encode(message: ProtobufMarkets.SpreadHistoryUpdate.ISpreadHistoryPoint, writer?: $protobuf.Writer): $protobuf.Writer;
             ...
             * @returns Writer
             */
            public static encodeDelimited(message: ProtobufMarkets.SpreadHistoryUpdate.ISpreadHistoryPoint, writer?: $protobuf.Writer): $protobuf.Writer;

            /**
             * Decodes a SpreadHistoryPoint message from the specified reader or buffer.
             * @param reader Reader or buffer to decode from
             * @param [length] Message length if known beforehand
             * @returns SpreadHistoryPoint
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): ProtobufMarkets.SpreadHistoryUpdate.SpreadHistoryPoint;
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): ProtobufMarkets.SpreadHistoryUpdate.SpreadHistoryPoint;
             ...
             * @returns SpreadHistoryPoint
             */
            public static fromObject(object: { [k: string]: any }): ProtobufMarkets.SpreadHistoryUpdate.SpreadHistoryPoint;

            /**
             * Creates a plain object from a SpreadHistoryPoint message. Also converts values to other types if specified.
             * @param message SpreadHistoryPoint
             * @param [options] Conversion options
             * @returns Plain object
             */
            public static toObject(message: ProtobufMarkets.SpreadHistoryUpdate.SpreadHistoryPoint, options?: $protobuf.IConversionOptions): { [k: string]: any };
